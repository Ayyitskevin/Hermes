...
function scopeSummary(browser: TradeBrowserResult, currency: string): string {
  ...
  return `<article class="card trade-scope-summary" id="trade-scope-summary" tabindex="-1" aria-labelledby="trade-scope-summary-title">
    ...
    <p class="scope-boundary">Dashboard headline metrics, review progress, equity curve, Direction Mix, Opening Weekday Mix, Plan Check, Mistake Patterns, Emotion Patterns, and Setup Breakdown remain whole-workspace.</p>
  </article>`;
}
